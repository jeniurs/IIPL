...
from dataset import train_loaders,valid_loaders
from model import Transformer
from dataset import plot_loss, pre_process
...
def main():
    ...
    train(model=model,
        ...
        source_pad_id=pre_process.pad_token_id,
        target_pad_id=pre_process.pad_token_id,
        device=device,
